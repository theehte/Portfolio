...
const projectCategories = [
  ...
  },
  {
    ...
    projects: [
      ...
      {
        title: 'XV6 OS Quiz',
        description: 'An operating-systems assessment project built around the XV6 teaching kernel.',
        tags: ['XV6', 'Operating Systems', 'Assessment'],
        url: 'https://github.com/theehte/B21ES013_OSQUIZ',
      },
    ],
  },
]
      ...
      <main>
        <section className="hero" id="top">
          ...
          <div className="hero-copy">
            ...
            <h1 aria-label="Thoughtful systems built to move work forward">
              <span className="hero-line"><span>Thoughtful systems,</span></span>
              <span className="hero-line"><span>built to move</span></span>
          ...
          <div className="hero-visual" aria-label="Temporary portrait placeholder">
            <div className="portrait-frame">
              <img
                src="https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=1200&q=85"
                alt="A chair used as a temporary portrait placeholder"
              />
              <div className="portrait-wash" />
              <p className="portrait-note"><Sparkles size={14} /> Photo placeholder</p>
            </div>
          </div>
        </section>
        ...
        <section className="work dark-section" id="work">
          ...
          <div className="category-intro reveal">
            <p>Projects are organized by the kind of problem they solve.</p>
        ...
        <section className="contact" id="contact">
          ...
          <footer>
            <a className="wordmark footer-mark" href="#top">ME<span>.</span></a>
            <p>Designed around curiosity. Engineered for impact.</p>
            <p>2026 Md Ehtesham</p>
          </footer>
        </section>
      </main>
    </div>
